...
You can run Found404 using [Podman](https://podman.io/) without installing Node or any dependencies locally.
...
```bash
podman pull quay.io/xaneeeey/found404
```

### Running the Container
```bash
podman run -it --name found404 -p 3000:3000 quay.io/xaneeeey/found404
```
This exposes the app on port 3000.
Visit http://localhost:3000

### Stop and Remove Container
```bash
podman stop found404
podman rm found404
```
## Running Locally
### Prerequisites
...
>>>>>>> 171053f (Initial Commit)
>>>>>>> acbdc68 (Initial Commit)
